...
public class Supplier implements Serializable {
	...
	//cascade，當有新增的supplier資料，會把連動的相關資料一起抓進來
	@OneToMany(mappedBy="supplier", cascade = CascadeType.PERSIST) //先對應supplier再去找coffee
	private List<Coffee> coffees; //後面有get、set、add、remove
